...
class GraphFactorization(object):
    def __init__(self, graph, rep_size=128, max_iter=100, learning_rate=0.01, lamb=1., adj_mat=None):
        ...
        self.adj_mat = nx.to_numpy_matrix(self.g.G)
        self.vectors = {}
    ...
    def get_train(self):
        ...
        _embeddings = tf.Variable(tf.random_normal([self.node_size, self.rep_size], stddev=np.sqrt(2./(self.node_size+self.rep_size))))
